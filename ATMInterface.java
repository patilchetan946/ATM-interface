...
public class ATMInterface {
    public static void main(String[] args) {
        ...
        User aUser = theBank.addUser("Chetan", "Patil", "chetan@1234");
        ...
        User curUser;
        while (true) {
            curUser = ATMInterface.mainMenuPrompt(theBank, sc);
            ATMInterface.printUserMenu(curUser, sc);
        }
    }
    ...
    public static void printUserMenu(User theUser, Scanner sc) {
        ...
        switch (choice) {
            case 1:
                ATMInterface.showTransactionHistory(theUser, sc);
                break;
            case 2:
                ATMInterface.withdrawFunds(theUser, sc);
                break;
            case 3:
                ATMInterface.depositeFunds(theUser, sc);
                break;
            case 4:
                ATMInterface.transferFunds(theUser, sc);
                break;
            case 5:
                sc.nextLine();
                break;
        ...
        if (choice != 5) {
            ATMInterface.printUserMenu(theUser, sc);
        }
    }
